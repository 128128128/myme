...
public:
	...
	void render(ID3D11DeviceContext* immediate_context, const DirectX::XMFLOAT4X4& world, ID3D11PixelShader* replaced_pixel_shader= nullptr, ID3D11VertexShader* use_vertex_shader=nullptr);
