...
class pbr_dynamic_mesh
{
public:
	pbr_dynamic_mesh(ID3D11Device* device, const char* filename, const char* pbr_metallic_filename,int pbr_texture_number=1,bool triangle = false, int animation_sampling_rate = 0);
	pbr_dynamic_mesh(ID3D11Device* device, const char* filename, const char* pbr_metallic_filename, const char* animation_filenames[], size_t number_of_animations, int pbr_texture_number = 1, bool triangle = false, int animation_sampling_rate = 0);

	virtual ~pbr_dynamic_mesh() = default;
	pbr_dynamic_mesh(pbr_dynamic_mesh&) = delete;
	pbr_dynamic_mesh& operator =(pbr_dynamic_mesh&) = delete;
