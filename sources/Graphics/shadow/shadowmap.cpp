...
void shadowmap::clear(ID3D11DeviceContext* immediate_context,
...
void shadowmap::active(ID3D11DeviceContext* immediate_context)
{
...
void shadowmap::inactive(ID3D11DeviceContext* immediate_context)
{
