...
//	_ASSERT_EXPR(SUCCEEDED(hr), hr_trace(hr));
//
//	create_vs_from_cso(device, "shader//husk_particles_vs.cso", vertex_shader.ReleaseAndGetAddressOf(), nullptr, nullptr, 0);
//	create_ps_from_cso(device, "shader//husk_particles_ps.cso", pixel_shader.ReleaseAndGetAddressOf());
//	create_gs_from_cso(device, "shader//husk_particles_gs.cso", geometry_shader.ReleaseAndGetAddressOf());
//	create_cs_from_cso(device, "shader//husk_particles_cs.cso", compute_shader.ReleaseAndGetAddressOf());
//
//	create_ps_from_cso(device, "shader//accumulate_husk_particles_ps.cso", accumulate_husk_particles_ps.ReleaseAndGetAddressOf());
//}
//
...
husk_particles::husk_particles(ID3D11Device* device, size_t max_particle_count) : max_particle_count(max_particle_count)
{
	...
	create_ps_from_cso(device, "shader//accumulate_husk_particles_ps.cso", accumulate_husk_particles_ps.ReleaseAndGetAddressOf());
	create_cs_from_cso(device, "shader//hask_particles_copy_buffer_cs.cso", copy_buffer_cs.ReleaseAndGetAddressOf());
}
