...
{
	trees = std::make_unique<static_mesh>(device, ".\\resources\\enviroments\\trees\\tree_B_0124.fbx");
	trunks = std::make_unique<static_mesh>(device, ".\\resources\\enviroments\\trees\\tree_T_0124_1.fbx");
