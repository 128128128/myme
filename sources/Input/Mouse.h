...
public:
	...
	// マウスカーソルX座標SET
	void SetPositionX(int posX) {positionX[0]=posX; }

	// マウスカーソルY座標SET
	void SetPositionY(int posY) { positionY[0]=posY; }
	...
	bool GetUpnNotch() const { return nNotch > 0; }

	bool GetDownnNotch()const { return nNotch < 0; }

	void restnNotch() { nNotch = 0; }

	void setnNotch(int nNotch) { this->nNotch = nNotch; }
private:
