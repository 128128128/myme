...
{
public:
	static const GamePadButton BTN_UP				= (1 <<  0);//↑ Key
	static const GamePadButton BTN_RIGHT			= (1 <<  1);
	static const GamePadButton BTN_DOWN				= (1 <<  2);
	static const GamePadButton BTN_LEFT				= (1 <<  3);
	static const GamePadButton BTN_A				= (1 <<  4);//Z key
	static const GamePadButton BTN_B				= (1 <<  5);//Space Key
	static const GamePadButton BTN_X				= (1 <<  6);//C Key
	static const GamePadButton BTN_Y				= (1 <<  7);//V Key
	...
	static const GamePadButton KEY_W = (1 << 16);
	static const GamePadButton KEY_A = (1 << 17);
	static const GamePadButton KEY_S = (1 << 18);
	static const GamePadButton KEY_D = (1 << 19);
	static const GamePadButton KEY_I = (1 << 20);
	static const GamePadButton KEY_J = (1 << 21);
	static const GamePadButton KEY_K = (1 << 22);
	static const GamePadButton KEY_L = (1 << 23);
